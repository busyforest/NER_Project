...
if __name__ == "__main__":
    # check(language = "Chinese", gold_path="Chinese/validation.txt", my_path="Chinese/result.txt")
    check(language="English", gold_path="English/validation.txt", my_path="English/result.txt")